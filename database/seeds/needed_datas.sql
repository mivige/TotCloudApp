...
-- ////////////////////
-- Insert Dedicated Server related data
...
INSERT INTO wh_cdn (name, endpoint, cacheExpiration, bandwidth) VALUES 
('Cloudflare', 'cdn.cloudflare.com', 3600, 10000);

INSERT INTO wh_cdn_geolocation (region, latency, FK_CDN) VALUES 
('North America', 20, 1),
('Europe', 35, 1),
('Asia Pacific', 50, 1);
