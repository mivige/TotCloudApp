...
<div class="row m-0">
    <div class="col-lg container-fluid page__container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Database Memory Options</li>
        </ol>

        <h1 class="h2">DB Storage</h1>
        <ol class="breadcrumb">
        ...
        <div class="card border-left-3 border-left-danger card-2by1">
            <div class="card-body">
                <form id="dbmsForm" action="api/actions/app_update_saas_memory.php" method="post" class="needs-validation">
                    <div class="row mb-3">
                        ...
                        <div class="col-4">
                            ...
                            <input maxlength="256" type="number" class="form-control" value="<?php echo $capacity ?>" id="capacity" name="capacity" required>
                            <div class="invalid-feedback">
                                Please, insert the capacity.
                            </div>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="col-4">
                            ...
                            <input maxlength="256" type="number" class="form-control" value="<?php echo $speed ?>" id="speed" name="speed" required>
                            <div class="invalid-feedback">
                                Please, insert the speed (in MB/s).
                            </div>
                        </div>
                    </div>
        ...
        <script>
                ...
                cancelButtonColor: "#3085d6",
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            data: parametros,
                            type: "POST",
                            url: "api/actions/app_delete_saas_memory.php",
            ...
            function pulsar_modificar(id) {
                window.location.href = `index.php?opcion=saas_storage&id=${id}&modificar=1`;
            }
        </script>
        ...
        <div class="card table-responsive" data-toggle="lists" data-lists-values='["js-lists-values-name", "js-lists-values-version", "js-lists-values-licenseType"]' data-lists-sort-by="js-lists-values-name" data-lists-sort-asc="true">
            <table class="table mb-0">
                <thead class="thead-light">
                    <tr>
                        <th><a href="javascript:void(0)" class="sort" data-sort="js-lists-values-name">Capacity</a></th>
                        <th><a href="javascript:void(0)" class="sort" data-sort="js-lists-values-version">Type</a></th>
                        <th><a href="javascript:void(0)" class="sort" data-sort="js-lists-values-licenseType">Speed</a></th>
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody class="list">
                    <?php while ($row = $result->fetch_assoc()) { ?>
                        <tr>
                            <td><span class="js-lists-values-name"><?php echo $row["capacity"]; ?></span></td>
                            <td><span class="js-lists-values-version"><?php echo $row["type"]; ?></span></td>
                            <td><span class="js-lists-values-licenseType"><?php echo $row["speed"]; ?></span></td>
                            <td>
