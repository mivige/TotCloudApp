...
if(!empty($modificar) and !empty($id)){
    ...
    $stmt = $dbb->prepare("SELECT id,code,description,discount FROM commitment_period WHERE id= ? ");
  ...
  $stmt = $dbb->prepare('select id,code,description,discount from commitment_period ');
...
<div class="row m-0">
    <div class="col-lg container-fluid page__container">
        ...
        <h1 class="h2">Commitment Period Management</h1>
        <ol class="breadcrumb">
...
<?php } ?> 
        ...
        <form id="incidenciaForm" action="api/actions/app_update_paas_commitment_period.php" method="post" class="needs-validation" >
         ...
         <input type="hidden" name="id" value="<?php echo $id ?>">
            ...
            <?php } else {?>
                ...
                <div class="col-2">
                    <label for="discount" class="form-label">Disccount</label>
                    <input maxlength="20" type="text" class="form-control" value="<?php echo $discount ?>" id="discount" name="discount" required pattern="^-?\d+(\.\d{1,2})?$">
                    <div class="invalid-feedback">
                        Please, insert the discount.
                    </div>
                </div>
                                    ...
                                    <thead class="thead-light">
                                        <tr>
                                            <th colspan="4">
                                                ...
                                                <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-amount">Discount</a>
                                    ...
                                    <?php while ($row = $result->fetch_assoc()) {?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex align-items-center">
                                                    <small class="text-uppercase text-muted mr-2">DISCOUNT</small>
                                                    <small class="text-uppercase"><span class="js-lists-values-amount"><?php echo $row["discount"]; ?>&nbsp;%</span></small>
                                                </div>
                                            </td>
