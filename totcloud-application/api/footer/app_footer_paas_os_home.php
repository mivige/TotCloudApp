...
function pulsar_modificar(id) {
    ...
    window.location.replace('index.php?opcion=paas_os&modificar=1&id='+id);
}
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                data: parametros,
                type: "POST",
                url: "api/actions/app_delete_paas_os.php",
                success: function(data) {
                    if (data === 'OK') {
                        Swal.fire({
                            ...
                            window.location.replace('index.php?opcion=paas_os');
                        });
                    } else {
