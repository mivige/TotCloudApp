...
if(!empty($modificar) and !empty($id)){
    ...
    $stmt = $dbb->prepare("SELECT * FROM paas_private_bandwidth WHERE id= ? ");
  ...
  $stmt = $dbb->prepare('select * from paas_private_bandwidth pb inner join currencytype ct on pb.currency_type =ct.currency_code');
...
<div class="row m-0">
    <div class="col-lg container-fluid page__container">
        ...
        <h1 class="h2">Private Bandwith Management</h1>
        <ol class="breadcrumb">
...
<?php } ?> 
        ...
        <form id="incidenciaForm" action="api/actions/app_update_paas_private_bandwidth.php" method="post" class="needs-validation" >
