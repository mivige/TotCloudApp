...
if(!empty($modificar) and !empty($id)){
    ...
    $stmt = $dbb->prepare("SELECT * FROM paas_os WHERE id= ? ");
  ...
  $stmt = $dbb->prepare('select * from paas_os po inner join currencytype ct on po.currency_type =ct.currency_code');
...
<?php } ?> 
        ...
        <form id="incidenciaForm" action="api/actions/app_update_paas_os.php" method="post" class="needs-validation" >
        ...
        <div class="row mb-3">
                ...
                <div class="col-12">
                    ...
                    <input maxlength="255" type="text" class="form-control" value="<?php echo $name ?>" id="name" name="name" required>
                    <div class="invalid-feedback">
                                    ...
                                    <thead class="thead-light">
                                        <tr>
                                            <th colspan="4">
                                                ...
                                                <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-status">Name</a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <small class="text-uppercase"><span class="js-lists-values-status"><?php echo $row["name"]; ?></span></small>
                                                </div>
                                            </td>
