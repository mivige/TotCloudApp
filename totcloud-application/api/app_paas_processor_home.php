...
if(!empty($modificar) and !empty($id)){
    ...
    $stmt = $dbb->prepare("SELECT * FROM paas_processor WHERE id= ? ");
  ...
  $stmt = $dbb->prepare('select * from paas_processor pp inner join currencytype ct on pp.currency_type =ct.currency_code');
...
<div class="row m-0">
    <div class="col-lg container-fluid page__container">
        ...
        <h1 class="h2">Processor Management</h1>
        <ol class="breadcrumb">
...
<?php } ?> 
        ...
        <form id="incidenciaForm" action="api/actions/app_update_paas_processor.php" method="post" class="needs-validation" >
