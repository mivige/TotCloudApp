...
if(!empty($modificar) and !empty($id)){
    ...
    $stmt = $dbb->prepare("SELECT * FROM paas_datacenterregion WHERE id= ? ");
  ...
  $stmt = $dbb->prepare('select * from paas_datacenterregion pd inner join currencytype ct on pd.currency_type =ct.currency_code');
...
<div class="row m-0">
    <div class="col-lg container-fluid page__container">
        ...
        <h1 class="h2">Data Center Region Management</h1>
        <ol class="breadcrumb">
...
<?php } ?> 
        ...
        <form id="incidenciaForm" action="api/actions/app_update_paas_datacenterregion.php" method="post" class="needs-validation" >
